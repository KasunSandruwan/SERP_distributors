            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form id="profile_form_customer" class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3" for="Credit Limit">Credit Limit
                            </label>
                            <div class="col-md-6 col-sm-6">
                                <input type="text" id="credit_limit"
                                       name="credit_limit" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
    ...
    $("#profile_form_customer").submit(function (e) {
        ...
        $.post(url, dataform, function (response) {
            ...
            if (response === "true") {
                ...
                document.getElementById("profile_form_customer").reset();
