...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        // skip  : $('<a>'+options.labelSkip+'</a>').attr("href","#").addClass("buttonSkip"),
    };
    ...
    var _init = function($this) {
        ...
        $($this.buttons.skip).click(function() {
            $this.skip();
            return false;
        });
    ...
    SmartWizard.prototype.skip = function(){
        var nextStepIdx = this.curStepIdx + 2;
        if (this.steps.length <= nextStepIdx){
            if (! this.options.cycleSteps){
                return false;
            }
